...
For more details about deployment options, visit [sizing your environment - Camunda 8 Self-Managed](../../advice/best-practices/architecture/sizing-your-environment.md#camunda-platform-8-self-managed).
